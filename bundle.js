...
For more info, visit https://fb.me/react-mock-scheduler`);
  ...
  const App = () => {
    const dvorak = "abcdefghijklmnopqrstuvwxyz".split("");
    const qwerty = "axje.uidchtnmbrl'poygk,qf;".split("");
    let benis = "";
    function dothething() {
    }
    return React.createElement("div", null, React.createElement("h2", null, "Enter message"), React.createElement("input", {
      value: (void 0).state.value,
      onChange: dothething
    }), React.createElement("h2", null, benis));
  };
